...
def iterative_second_block(iter0_read, TP, n2, size0, size1):
...
if __name__ == "__main__":
    ...
    TWIDDLE_tuple_map = find_twiddle_map(N, q)
    ...
    if iterative_seven:
        ...
        iter_1_read = iterative_second_block(iter_0_read, TP, n2, size0, size1)
        ...
        iter_3_read = iterative_second_block(iter_0_read, TP, n2, n1, n1*n2)
    elif iterative_six:
        print("eee")
        iter_0_read = iterative_first_block1(input1, TP, n1, n2, size0, bram_skip=False)

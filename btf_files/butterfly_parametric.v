...
module butterfly_parametric#(parameter LOGQ = 32)
                (
                 input clk,rst,
...
modadd_parametric#(.LOGQ(LOGQ), .Reduc_param(17)) ma0(w1,w0,q_addsub,w2);
modsub_parametric#(.LOGQ(LOGQ), .Reduc_param(17)) ms0(w1,w0,q_addsub,w3);
